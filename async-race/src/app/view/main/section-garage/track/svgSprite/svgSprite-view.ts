...
//     createNewElement(tagName: string, id?: string, attribute?: string): HTMLElement {
//         const element = document.createElement(`${tagName}`);
//         return element;
//     }

//     createSvgSprite() {
//         const svgNone: HTMLElement = this.createNewElement(this.htmlTeg.svg);
//         const svgSymbol: HTMLElement = this.createNewElement(this.htmlTeg.symbol, this.id.car, );
//         svgNone.style.display = 'none';
//     }
// }
